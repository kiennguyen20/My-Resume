        ...
        <S.Wrapper>
          <S.Left>
            ...
            <S.Content>
              ...
              developer with 6 months of experience in ReactJS framework and 3
            ...
            <S.Content>
              In Web Suite (HTML, CSS and JS), I love coding with SCSS, and have
              a quite good skill about responsive website.
            </S.Content>
            <S.Content>
              Most of my skills are learn by watching Youtube tutorials,
              learning course (in Udemy and FreeCodeCamp) and reading books
              (being a big fan of O'REILLY) and documents. After learning a new
              technology, I always use it to build a real project. That’s my
              method which makes it easy for me to learn fast.
            </S.Content>
          </S.Left>
          <S.Right>
            ...
            <S.RightContent>
              <LocationOnIcon
                style={{ marginRight: '10px', fontSize: '4rem' }}
              />
